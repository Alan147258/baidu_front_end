function Plane(index,speed,energyConsumption,chargingSpeed){
    var that = this;
    this.index = index;
    ...
    this.speed = speed;
    this.chargingSpeed = (function(){return that.maxEnergy*chargingSpeed/20;})();
    ...
    this.angle = 0;
    this.consume = that.maxEnergy*energyConsumption/20;
